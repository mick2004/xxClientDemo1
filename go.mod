...
require (
	...
	gitlab.com/elixxir/primitives v0.0.3-0.20220323183834-b98f255361b8 // indirect
	...
	gitlab.com/xx_network/primitives v0.0.4-0.20220324193139-b292d1ae6e7e // indirect
